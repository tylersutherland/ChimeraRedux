...
public class MenuScreen implements Screen {
	...
	public void resize(int width, int height) {
		...
		playButton.setY(Gdx.graphics.getHeight() / 2 - playButton.getHeight() / 2 + playButton.getHeight());
		...
		quitButton.setY(Gdx.graphics.getHeight() / 2 - quitButton.getHeight() / 2 - quitButton.getHeight());
		quitButton.center();
